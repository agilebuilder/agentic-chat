...
- Beta Trusted Publishing remains main-only, protected and provenance-enabled. RC/stable release workflow and protected environment remain required before P4.6.
